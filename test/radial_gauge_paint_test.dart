...
void main() {
  testWidgets('RadialGauge zones follow parent offset (Padding)', (
    tester,
  ) async {
  ...
  testWidgets('RadialGauge zones follow parent offset (Row of two gauges)', (
    tester,
  ) async {
                  ...
                  child: RadialGauge(
                    ...
                    axis: GaugeAxis(
                      ...
                      zones: [
                        ...
                        GaugeZone(from: 75, to: 100, color: Color(0xFFF44336)),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: RadialGauge(
                    ...
                    axis: GaugeAxis(
                      ...
                      zones: [
                        ...
                        GaugeZone(from: 90, to: 120, color: Color(0xFF009688)),
                      ],
                    ),
                  ),
                ),
